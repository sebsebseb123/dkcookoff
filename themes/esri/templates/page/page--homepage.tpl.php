<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div id="main" class="clearfix">
    ...
    <div class="main-inner">
      <?php if ($page['focal']): ?>
      <div class="focal-slide-wrap">
        <?php print render($page['focal']); ?>
      </div>
      <div class="focal-pagination-rsp">
        <a href="javascript:void(0);" class="focal-prev"><?php print t('Prev') ?></a>
        <a href="javascript:void(0);" class="focal-next"><?php print t('Next') ?></a>
      </div>
      <?php endif; ?>
        ...
        <div id="content">
          <div id="content-inner" class="inner column center">
            ...
            <?php if ($breadcrumb || $title|| $messages || $tabs || $action_links): ?>
              <div id="content-header" class="element-invisible">
